	...
	for(let content of data) {
		const listContent = `
				<li class="todo-content">
                    <input type="checkbox"  id="complete-check-${content.todoCode}" class="complete-check" checked = ${content.todoComplete ? 'checked' : ' '}>
                    ...
                    <input type="checkbox" id="importance-check-${content.todoCode}" class="importance-check" checked = ${content.importance ? 'checked' : ' '}>
